...
angular.module("appDep").controller("usersBookingsCtrl", [ "$scope", "data", function($scope, data) {
    $scope.data = data;
    ...
    $scope.user = {
        ...
        cakeQuery.querypost({
            ...
            return value.data && value.data.state ? "success" != value.data.state ? $scope.displayError() : void $state.go("bookings", {}) : $scope.displayError();
        }, function() {
            growl.error("Le serveur n'a pas répondu, veuillez essayer à nouveau!");
        });
    };
