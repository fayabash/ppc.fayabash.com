<section>
    ...
    <?php foreach ($tournaments as $table): ?>
        ...
        <div class="jumbotron">
            ...
            ?>
            <h3>Mercredi <?php echo $date; ?> de <?php echo $start; ?> à <?php echo $end; ?></h3>
            <p>Il reste encore <?php echo $table['Pitch']['user_left']; ?> place(s) disponible(s)</p>
    ...
    if (count($tournaments) == 0) {
        echo $this->Html->tag('p', 'Il n\'y a plus de de tournoi cette semaine :/ Next week ? :)', array('class' => 'alert alert-warning'));
    }
    ?>
